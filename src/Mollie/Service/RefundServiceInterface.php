...
interface RefundServiceInterface
{
     ...
     *
     * @param PaymentContractInterface $contract The contract to refund
     * @param float|null $amount Partial amount (null = full refund)
     * @param string|null $reason Standard reason code (requested_by_customer, duplicate, fraudulent)
     * @param string|null $idempotencyKey Idempotency key for API deduplication
     * @param string|null $description Optional admin description for audit trail
