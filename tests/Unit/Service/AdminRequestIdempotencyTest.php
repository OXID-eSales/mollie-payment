 ...
 * honours the Mollie idempotency-key header returns the cached refund on the second call instead
...
final class AdminRequestIdempotencyTest extends TestCase
{
    ...
    public function testRefund_SameContractAmountTwice_SecondIsNoOpAtApi(): void
    {
        ...
        $service = new RefundService($paymentsAdapter, $refundAdapter, new ContractRefundRecorder($contractRepository));
